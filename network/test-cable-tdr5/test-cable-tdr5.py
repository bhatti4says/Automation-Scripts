...
SW_USERNAME = os.getenv("NET_USERNAME")          # Only if a switch ever asks for Username:
SW_PASSWORD = os.getenv("NET_PASSWORD")    # Switches prompt for password directly in your environment
