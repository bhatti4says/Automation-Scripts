...
SW_USERNAME = os.getenv("NET_USERNAME")          # Only used if a switch ever asks for Username:
SW_PASSWORD = os.getenv("NET_PASSWORD")    # Per your note: switch typically asks for password directly
